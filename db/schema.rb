...
ActiveRecord::Schema.define(version: 2020_08_27_014633) do
  ...
  create_table 'jwt_deny_list', force: :cascade do |t|
    ...
    t.index %w[jti], name: 'index_jwt_deny_list_on_jti'
  end
  ...
  create_table 'listings', force: :cascade do |t|
    ...
    t.index %w[player_id], name: 'index_listings_on_player_id'
    t.index %w[user_id], name: 'index_listings_on_user_id'
  end
  ...
  create_table 'stripe_accounts', force: :cascade do |t|
    ...
    t.index %w[token], name: 'index_stripe_accounts_on_token'
  end
  ...
  create_table 'stripe_customers', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[token], name: 'index_stripe_customers_on_token'
  end
